...
KEYCLOAK_CLIENT_ID = 'local-django-abdullah.hamad@huskers.unl.edu'
KEYCLOAK_CLIENT_SECRET = '74b9105e-695b-4711-83e0-19f5d5d29c00'
KEYCLOAK_AUTHORIZE_URL = 'https://iamdev.scigap.org/auth/realms/rnamake/protocol/openid-connect/auth'
KEYCLOAK_TOKEN_URL = 'https://iamdev.scigap.org/auth/realms/rnamake/protocol/openid-connect/token'
KEYCLOAK_USERINFO_URL = 'https://iamdev.scigap.org/auth/realms/rnamake/protocol/openid-connect/userinfo'
KEYCLOAK_LOGOUT_URL = 'https://iamdev.scigap.org/auth/realms/rnamake/protocol/openid-connect/logout'
...
AUTHENTICATION_OPTIONS = {'password': {'name': 'RNAMake'}, 'external': [{'idp_alias': 'cilogon', 'name': 'Existing Institute Login'}]}
...
GATEWAY_DATA_STORE_REMOTE_API = 'https://dev.rnamake.scigap.org/'
